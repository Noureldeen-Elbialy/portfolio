    ...
    return (
        <>
            <aside className="bg-gray-100 text-center sticky h-dvh top-0 left-0 bottom-0 pt-10 text-xs">
                <img src={Img} className="w-36 h-36 m-auto rounded-full my-4" alt="person" />
                <h1 className="font-main text-[22px] font-bold">Jackson Ford</h1>
                <p className="mt-4 mb-6"><span className="text-blue-400">UI/UX/DESIGNER</span> IN PHILLIPPINES</p>
                <ul className="space-y-5 tracking-wider">
